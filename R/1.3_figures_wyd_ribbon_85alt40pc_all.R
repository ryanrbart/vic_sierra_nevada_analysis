# Ribbon Plots - all watersheds - 85alt40pc
...
x <- ggplot() +
  ...
  NULL
plot(x)
ggsave("output/mean_daily_et_ribbon_85alt40pc_all.jpg", width = 6, height = 10)
...
x <- ggplot() +
  ...
  NULL
plot(x)
ggsave("output/mean_daily_q_ribbon_85alt40pc_all.jpg", width = 6, height = 10)
...
x <- ggplot() +
  ...
  NULL
plot(x)
ggsave("output/mean_daily_swe_ribbon_85alt40pc_all.jpg", width = 6, height = 10)
